...
rp({
  ...
  url: 'https://maps.googleapis.com/maps/api/directions/json?origin=Brooklyn&destination=Queens&mode=transit&key=AIzaSyAzntD6joQkWskYP1kPmI32GcxpJE-nTB8',
  json: true
})
.then((data) => {
  ...
  return rp({
    method: 'GET',
    url: 'https://itunes.apple.com/search?term=news&media=podcast&country=gb&limit=10',
    json: true
  });
})
.then(data => {
